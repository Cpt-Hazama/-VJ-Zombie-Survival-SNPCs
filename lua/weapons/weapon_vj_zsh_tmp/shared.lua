...
SWEP.PrintName					= "Silenced Steyr TMP"
...
SWEP.Primary.Recoil				= 1.2 -- How much recoil does the player get?
...
SWEP.Reload_TimeUntilFinished	= 2.3 -- How much time until the player can play idle animation, shoot, etc.
---------------------------------------------------------------------------------------------------------------------------------------------
