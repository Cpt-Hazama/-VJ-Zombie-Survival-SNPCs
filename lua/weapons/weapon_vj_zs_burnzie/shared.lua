...
function SWEP:ZS_Animations(vel,maxSeqGroundSpeed)
	local animIdle = self.Owner:GetSequenceActivity(self.Owner:LookupSequence("zombie_run"))
	local animMove = self.Owner:GetSequenceActivity(self.Owner:LookupSequence("zombie_run"))
