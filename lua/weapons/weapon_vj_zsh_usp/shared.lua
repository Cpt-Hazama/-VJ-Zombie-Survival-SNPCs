...
SWEP.Primary.Recoil				= 0.45 -- How much recoil does the player get?
SWEP.Primary.Delay				= 0.145 -- Time until it can shoot again
...
SWEP.Reload_TimeUntilFinished	= 2.6 -- How much time until the player can play idle animation, shoot, etc.
---------------------------------------------------------------------------------------------------------------------------------------------
