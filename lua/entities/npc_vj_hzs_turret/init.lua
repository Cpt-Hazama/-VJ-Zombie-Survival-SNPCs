...
function ENT:CustomOnInitialize()
	...
	if #self.Turret_FireSound <= 0 then
		self.Turret_FireSound = {"weapons/smg1/smg1_fire1.wav"}
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:CustomRangeAttackCode()
	for i = 1,self.Turret_BulletAmount do
		local bullet = {}
		bullet.Num = 1
	...
	ParticleEffectAttach("vj_rifle_full",PATTACH_POINT_FOLLOW,self,self.Turret_BulletAttachmentParticle)
	...
	FireLight1:Fire("Color", "255 140 0")
